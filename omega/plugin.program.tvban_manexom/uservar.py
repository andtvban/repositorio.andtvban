...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[B][COLOR azure]TVBAN [COLOR green]MAT[COLOR purple]NEX[COLOR deepskyblue]OM[/COLOR][/B]'
...
# Font size of header
FONTHEADER = ''
HEADERMESSAGE = '[B][COLOR azure]TVBAN [COLOR green]MAT[COLOR purple]NEX[COLOR deepskyblue]OM[/COLOR][/B]'
