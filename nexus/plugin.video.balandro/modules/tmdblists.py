...
def mainlist(item):
    ...
    itemlist.append(item.clone( action='listado_personas', search_type='person', extra = 'popular', title=' - [COLOR limegreen]Personas[/COLOR] más populares', thumbnail=config.get_thumb('search') ))
